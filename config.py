...
from mobile_tests_5_23.helpers import file
...
class Settings(pydantic.BaseSettings):
    ...
    # --- Remote Driver ---
    remote_url: str = 'http://hub.browserstack.com/wd/hub'  # it's a default appium server url
    ...
    def in_context(cls, env: Optional[EnvContext] = None) -> 'Settings':
        ...
        return cls(
            _env_file=file.abs_path_from_project(
